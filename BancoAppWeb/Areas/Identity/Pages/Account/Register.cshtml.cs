...
namespace BancoAppWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private IdentityUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException(
                    $"Unable to create '{nameof(IdentityUser)}'. Asegúrate que tiene constructor sin parámetros."
                );
            }
        }
        ...
        private IUserEmailStore<IdentityUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
                throw new NotSupportedException("Este proyecto requiere soporte de email.");
